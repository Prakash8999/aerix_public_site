...
const mockModels = [
  {
    ...
    monthlyEmi: "2,399",
    images: [
      "https://cdn.aerixenergy.com/images/90e25573-c465-4587-bef5-6274f295a589.png",
      "https://cdn.aerixenergy.com/images/d01cc6f8-de6b-4e64-866f-ba77e18918a1.png",
      "https://cdn.aerixenergy.com/images/d994d8c6-accf-4516-a5c5-58b0f4fce382.png",
      "https://cdn.aerixenergy.com/images/d1f60d39-f380-4aac-804e-e05ccf37f430.png",
      "https://cdn.aerixenergy.com/images/72808d24-8ceb-4d35-bb6f-b0cda9c1a79e.png",
    ],
    range: 90,
    topSpeed: "45-50 km/h",
  ...
  },
  {
    ...
    monthlyEmi: "2,599",
    images: [
      "https://cdn.aerixenergy.com/images/9aa2ad77-29e0-4d26-94ee-c3d2b7bed337.png",
      "https://cdn.aerixenergy.com/images/bbb6698f-8055-4c29-b5c0-fa03575c3488.png",
      "https://cdn.aerixenergy.com/images/a9be4b3b-a1fd-414f-b07c-0fc6c76920a8.png",
      "https://cdn.aerixenergy.com/images/ad99a205-a999-4c1e-bc13-78f3111a6196.png",
      "https://cdn.aerixenergy.com/images/6a54a8af-dab4-4a5b-b352-6a301d75b919.png",
    ],
    range: 90,
    topSpeed: "45-50 km/h",
  ...
  },
  {
    ...
    images: [
      ...
      "https://cdn.aerixenergy.com/images/67c6bcbe-16c8-4a30-9db4-47a799c187ee.png",
      "https://cdn.aerixenergy.com/images/61632aec-1c2d-45ad-8b22-a0bacdcdd6e6.png",
      "https://cdn.aerixenergy.com/images/94fe2298-d8b3-4acb-987f-4455ac1dd297.png",
      "https://cdn.aerixenergy.com/images/366c7875-e0af-46aa-b9bb-03d266a6db98.png",
    ],
    range: 90,
    topSpeed: "55 km/h",
  ...
  },
  {
    ...
    monthlyEmi: "3,199",
    images: [
      "https://cdn.aerixenergy.com/images/73f1eb6a-f0dd-47bb-9a52-fcaba030dfca.png",
      "https://cdn.aerixenergy.com/images/0306c24c-5cd8-4e7b-a0d4-7cebe814a291.png",
      "https://cdn.aerixenergy.com/images/ce88bcc3-74ea-4d38-80a7-4412efb58754.png",
      "https://cdn.aerixenergy.com/images/99ee50b0-679f-4467-b51d-c93f43b92032.png",
      "https://cdn.aerixenergy.com/images/bfe5e84a-907d-4dd0-bda1-f8d0a5d5311d.png",
    ],
    range: 90,
    topSpeed: "45-50 km/h",
  ...
  },
  {
    ...
    images: [
      ...
      "https://cdn.aerixenergy.com/images/b60a5a9a-4ab6-403d-9405-395f080a51fb.png",
      "https://cdn.aerixenergy.com/images/441d0c9d-304b-4b72-8cd2-7d3c47c49180.png",
      "https://cdn.aerixenergy.com/images/25ec10b9-23e0-458b-aca7-85d1909a1de0.png",
    ],
    range: 90,
    topSpeed: "45-50 km/h",
  ...
  },
  {
    ...
    monthlyEmi: "3,499",
    images: [
      "https://cdn.aerixenergy.com/images/0688cc74-8064-498a-b1f5-0f7e1ee85030.png",
    ],
    range: 90,
    topSpeed: "40 km/h",
    colors: ["Black"],
...
const ProductCard = ({
  ...
  onEnquireClick: (name: string, color?: string) => void;
}) => {
      ...
      >
        ...
        <div className="relative w-full aspect-[4/3] rounded-[2rem] overflow-hidden duration-500 ease-out">
          ...
          <div className="absolute top-5 right-5 z-10">
            <Badge
              variant="secondary"
              className="backdrop-blur-md bg-white/70 hover:bg-white/90 text-foreground font-medium shadow-sm rounded-full px-3 py-1 border-0"
            >
          ...
          >
            {model.images.map((img, idx) => (
              <div
                key={idx}
                className="min-w-full h-full flex items-center justify-center snap-center p-0 md:px-4 md:pt-4 pointer-events-none select-none relative"
              >
                <Image
                  src={img}
        ...
        <div className="flex flex-col flex-1 px-5 pt-5 pb-4">
          ...
          <div className="flex items-center justify-between gap-2 md:gap-4">
            ...
            <div className="flex flex-col shrink-0">
              <p className="text-[9px] md:text-[10px] uppercase tracking-wider font-semibold text-muted-foreground">
                Starting at
              </p>
            ...
            <div className="flex items-center gap-1.5 md:gap-2 overflow-x-auto">
              <Button
                ...
                onClick={() =>
                  onEnquireClick(model.name.toUpperCase(), (model as any).color)
                }
              >
                Enquire
              </Button>
...
const MagicalCard = ({
  ...
  return (
    <div className="magical-card group/card relative h-64 rounded-xl">
      ...
      <div className="absolute inset-0 bg-[#262626] rounded-xl transition-colors duration-300 group-hover/card:bg-[#404040]">
      ...
      <div className="absolute inset-[1px] bg-[#101010] rounded-[11px] flex flex-col justify-end p-6 relative z-10 transition-colors duration-300 overflow-hidden">
        ...
        <h4 className="text-lg font-bold text-white mb-2 relative z-20 translate-y-2 group-hover/card:translate-y-0 transition-transform duration-300">
          {title}
        </h4>
...
const features = [
  {
    ...
    description:
      "Charge up to 80% in just 45 minutes with our hyper-charge technology.",
  },
  {
    icon: Shield,
    title: "Advanced Safety",
    description:
      "Rated 5-star safety with collision detection and anti-theft tracking.",
  },
  {
    icon: Smartphone,
    title: "Smart Connectivity",
    description:
      "Seamlessly connect with your phone for navigation and diagnostics.",
  },
  {
    icon: Globe,
    title: "Eco-Friendly",
    description:
      "Zero emissions, 100% recyclable materials, building a greener future.",
  },
  {
    icon: Cloud,
    title: "Cloud Updates",
    description: "Over-the-air software updates to keep your ride optimized.",
  },
  {
    icon: BarChart3,
    title: "Performance Analytics",
    description:
      "Track your rides, efficiency, and battery health in real-time.",
  },
];
    ...
    >
      <div className="container mx-auto px-4">
        ...
        >
          <Badge
            variant="secondary"
            className="px-4 py-1.5 text-sm font-medium rounded-full bg-white text-primary shadow-sm border-white/20"
          >
            Our Collection
          </Badge>
          ...
          <p className="text-xl text-muted-foreground/80 max-w-2xl mx-auto">
            ...
            scooters. Engineered for performance, styled for you.
          </p>
        </motion.div>
