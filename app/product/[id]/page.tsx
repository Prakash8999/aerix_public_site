...
export default function ProductDetailPage() {
  ...
  const availableColors = product
    ? product.colors.filter((c) => c in product.images)
    : [];
              ...
              >
                {slides.map((slide, idx) => (
                  ...
                  >
                    ...
                    {/* Content Overlay */}
                    <div
                      className={`absolute bottom-24 md:bottom-auto md:top-1/2 md:-translate-y-1/2 left-0 w-full px-6 sm:px-12 md:px-24 text-left z-20 transition-opacity duration-1000 ${
                        (idx === 0 && activeIndex === origSlides.length - 1) ||
                    ...
                    {/* Metric Overlay */}
                    <div
                      className={`absolute bottom-32 right-6 sm:right-12 md:right-24 z-20 text-right transition-all duration-1000 ease-out ${
                        (idx === 0 && activeIndex === origSlides.length - 1) ||
                        (idx === slides.length - 1 && activeIndex === 0) ||
                        idx === activeIndex + 1
                ...
                {origSlides.map((_, idx) => (
                  <button
                    ...
                    className={`h-2 rounded-full transition-all duration-500 shadow-sm ${
                      idx === activeIndex % origSlides.length
                        ? "w-8 bg-white"
        ...
        >
          <div className="text-center mb-10">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Premium components and cutting-edge technology for an unparalleled
              riding experience
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              ...
              <div className="mt-6">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Reach speeds up to {product.speed}, perfectly balanced for
                  urban mobility and highway safety standards.
                </p>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="mt-6">
                ...
                <p className="text-gray-600 leading-relaxed">
                  {product.brake} system ensures precise stopping power and
                  enhanced safety in all riding conditions.
                </p>
              </div>
            </motion.div>
          </div>
